...
router.post("/", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if(findUserErr) {
            ...
            dashboardDAO.createDashboard(dashboardObj, currentUser, function(err, result) {
                if(err) {
                    return next(err);
                } else {
...
router.put("/:dashboardId", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if(findUserErr) {
            ...
            dashboardDAO.editDashboard(dashboardObj, dashboardId, currentUser, function(err, result) {
                if(err) {
                    return next(err);
                } else {
                    return utils.successResponse(result, res, next);
...
router.delete("/:dashboardId", function(req, res, next) {
    ...
    checkAuth(req, res, next, function (findUserErr, currentUser) {
        if (findUserErr) {
            ...
            dashboardDAO.deleteDashboardById(dashboardId, currentUser, function (deleteErr, deleteResult) {
                if (deleteErr) {
 ...
 * @apiError message Error code
 */
router.post("/:dashboardId/tags/segments", function(req, res, next) {
    var dashboardId = req.params.dashboardId;
        ...
        if (findUserErr) {
            ...
            dashboardDAO.getDashboardById(dashboardId, currentUser, function (findErr, foundDashboard) {
                if (findErr) {
                    ...
                    dashboardDAO.createSegments(currentUser, foundDashboard, req.body, 
 ...
 * @apiError message Error code
 */
router.get("/:dashboardId/tags/segments/:segmentId", function(req, res, next) {
    var dashboardId = req.params.dashboardId;
 ...
 * @apiError message Error code
 */
router.put("/:dashboardId/tags/segments", function(req, res, next) {
    var dashboardId = req.params.dashboardId;
        ...
        if (findUserErr) {
            ...
            dashboardDAO.getDashboardById(dashboardId, currentUser, function (findErr, foundDashboard) {
                if (findErr) {
                    ...
                    dashboardDAO.updateSegments(currentUser, foundDashboard, req.body, 
                        function (error, savedDashboard) {
                        if (error) {
                            return next(error);
                        } else {
 ...
 * @apiError message Error code
 */
router.delete("/:dashboardId/tags/segments", function(req, res, next) {
    var dashboardId = req.params.dashboardId;
        ...
        if (findUserErr) {
            ...
            dashboardDAO.getDashboardById(dashboardId, currentUser, function (findErr, foundDashboard) {
                if (findErr) {
                    ...
                    dashboardDAO.removeSegments(currentUser, foundDashboard, filteredSegment, 
                        function (error, savedDashboard) {
                        if (error) {
                            return next(error);
                        } else {
 ...
 * @apiError message Error code
 */
router.delete("/:dashboardId/tags/segments/:segmentId", function(req, res, next) {
    var dashboardId = req.params.dashboardId;
    var segmentId = req.params.segmentId;
 ...
 * @apiError message Error code
 */
router.post("/:dashboardId/widgets", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            return next(findUserErr);
        } else {
            ...
            widgetDAO.createWidget(dashboardId, widgetObj, currentUser, function (err, result) {
                if (err) {
                    return next(err);
                } else {
                    return utils.successResponse(result, res, next);
 ...
 * @apiError message Error code
 */
router.put("/:dashboardId/widgets/:widgetId", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            return next(findUserErr);
        } else {
            ...
            widgetDAO.updateWidget(dashboardId, widgetObj, widgetId, currentUser, function (err, result) {
                if (err) {
                    return next(err);
                } else {
                    return utils.successResponse(result, res, next);
 ...
 * @apiError message Error code
 */
router.post("/:dashboardId/widgets/:widgetId/tags/segments", function(req, res, next) {
    var dashboardId = req.params.dashboardId;
    var widgetId = req.params.widgetId;
    ...
    checkAuth(req, res, next, function (findUserErr, currentUser) {
        if (findUserErr) {
            ...
            async.waterfall([
                function (cb) {
                    dashboardDAO.getDashboardById(dashboardId, currentUser, cb);
                }, function (dashboard, cb) {
                    widgetDAO.getWidgetById(widgetId, currentUser, function (err, widget) {
                        if (err) {
                            cb(err);
                        } else {
                    ...
                    widgetDAO.createSegments(currentUser, dashboard, widget, req.body, cb);
                }
            ], function (err, result) {
                if (err) {
                    return next(err);
 ...
 * @apiError message Error code
 */
router.put("/:dashboardId/widgets/:widgetId/tags/segments", function(req, res, next) {
    var dashboardId = req.params.dashboardId;
    var widgetId = req.params.widgetId;
        ...
        if (findUserErr) {
            ...
            async.waterfall([
                function (cb) {
                    ...
                    widgetDAO.updateSegments(currentUser, dashboard, widget, req.body, cb);
                }
            ], function (err, result) {
                if (err) {
                    return next(err);
 ...
 * @apiError message Error code
 */
router.delete("/:dashboardId/widgets/:widgetId/tags/segments", function(req, res, next) {
    var dashboardId = req.params.dashboardId;
    var widgetId = req.params.widgetId;
            ...
            async.waterfall([
                function (cb) {
                    ...
                    var filteredSegment = _.filter(widget.segments,
                        function(segment) { return segments.indexOf(segment.id.toString()) !== -1; });
                    widgetDAO.removeSegments(currentUser, dashboard, widget, filteredSegment,cb);
                }
            ], function (err, result) {
                if (err) {
                    return next(err);
 ...
 * @apiError message Error code
 */
router.delete("/:dashboardId/widgets/:widgetId/tags/segments/:segmentId", function(req, res, next) {
    var dashboardId = req.params.dashboardId;
    var widgetId = req.params.widgetId;
    var segmentId = req.params.segmentId;
 ...
 * @apiError message error code
 */
router.delete("/:dashboardId/widgets/:widgetId", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            return next(findUserErr);
        } else {
            var widgetId = req.params.widgetId;
            var dashboardId = req.params.dashboardId;
            widgetDAO.deleteWidgetById(dashboardId, widgetId, currentUser, function (err, answer) {
                if (err) {
                    return next(err);
                } else {
                    return utils.successResponse(answer, res, next);
 ...
 * @apiError message error code
 */
router.post("/export/widget/:widgetId", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            return next(findUserErr);
        } else {
 ...
 * @apiError message error code
 */
router.post("/export/:dashboardId", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            return next(findUserErr);
        } else {
