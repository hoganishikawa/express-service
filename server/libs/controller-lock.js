/**
*
* Locks execution of controller code with certain parameters
* in order to avoid unintendes second, third, etc. calls
* until previous code execution is done.
*
* Actually we should lock the channel per user, because we have
* no query info in response anyway.
*
*/
