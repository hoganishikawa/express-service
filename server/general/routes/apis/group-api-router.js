...
router.get("/available", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            ...
            groupDAO.getAvailableSources(currentUser, function(findErr, findObjects) {
                if (findErr) {
                    return next(findErr);
                } else {
...
router.post("/", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            ...
            groupDAO.createGroup(groupObj, currentUser, function (err, result){
                if (err) {
                    return next(err);
                } else {
...
router.post("/source", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            ...
            groupDAO.addSource(groupId, sourceId, sourceType, currentUser, function (err, result){
                if (err) {
                    return next(err);
                } else {
                    return utils.successResponse(result, res, next);
...
router.delete("/source", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            ...
            var sourceId = req.body.sourceId;
            var sourceType = req.body.sourceType;
            groupDAO.removeSource(groupId, sourceId, sourceType, currentUser, function (err, result){
                if (err) {
                    return next(err);
                } else {
                    return utils.successResponse(result, res, next);
...
router.put("/:groupId", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            ...
            groupDAO.editGroup(groupId, groupObj, currentUser, function (err, result) {
                if (err) {
                    return next(err);
                } else {
                    return utils.successResponse(result, res, next);
...
router.delete("/:groupId", function(req, res, next) {
    checkAuth(req, res, next, function(findUserErr, currentUser) {
        if (findUserErr) {
            ...
            groupDAO.deleteGroupById(idArray, currentUser, function (err, result) {
                if (err) {
                    return next(err);
                } else {
                    return utils.successResponse(result, res, next);
