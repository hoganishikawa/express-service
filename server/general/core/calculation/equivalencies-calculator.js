...
var moment = require("moment"),
    constEmissionFactor = 0.000823724,
...
function EquivalenciesCalculator(kwh, startDate, endDate) {
    this.kwh = kwh || 0;
...
EquivalenciesCalculator.prototype.calc = function() {
    var calcCOEmissions = constEmissionFactor * this.kwh;
    ...
    return {
        ...
        aaBatteries: (this.kwh / constAABatteries),
        refrigerators: (this.kwh / constRefrigerators),
        mobilePhones: (this.kwh / constMobilePhones),
